...
> **[정본 이관 안내]** 본 문서는 이전 버전(엑스컴 v2)이다. 최신 정본은 콘텐츠 제작사 배경으로 재구성된 **《최종_진짜최종: D-7》 v4.0** — [`FINAL-FINAL-D7-GDD.md`](./FINAL-FINAL-D7-GDD.md) — 를 참조하라. 본 문서는 60초 스크램블·로그라이크 구조의 원형 설계 기록으로 보존한다.
